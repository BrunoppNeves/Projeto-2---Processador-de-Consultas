  ...
  private readonly DATA_BASE = {
    ...
    "tables": [
      ...
      },
      {
        ...
        "foreignKey": [
          { "column": "TipoCliente_idTipoCliente", "references": { "table": "TipoCliente", "column": "idTipoCliente" } }
        ]
      },
      {
        "name": "TipoEndereco",
      ...
      },
      {
        ...
        "foreignKey": [
          { "column": "TipoEndereco_idTipoEndereco", "references": { "table": "TipoEndereco", "column": "idTipoEndereco" } },
